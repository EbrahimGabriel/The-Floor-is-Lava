...
public class SmallInfoLabel extends Label{
	private static final String FONT_PATH = "src/model/resources/rainyhearts.ttf";
	
	public SmallInfoLabel(String text) {
		setPrefHeight(30);
		setPrefWidth(130);
		BackgroundImage bgImg = new BackgroundImage(new Image("/view/resources/label_panel.png", 130, 30, false, true),
